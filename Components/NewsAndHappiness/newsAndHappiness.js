...
const NewsAndHappiness = () => {
  return (
    <div className="w-11/12 max-w-[1140px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
        <div className="newsAndHappinessBox card rounded-none card-compact bg-base-100 shadow-xl">
          <figure className="relative">
            <Image
              ...
              alt=""
            ></Image>
            <div className="absolute z-10 left-0 bottom-0 text-center bg-blue-500 px-6 py-3">
